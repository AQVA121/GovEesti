...
const socHealthSpendPerCapita: TrendSeries = {
  ...
  goodDirection: "up",
  vfm: true,
  producer: "Statistikaamet (RR056 expenditure; population denominator also Statistikaamet)",
  sourceUrl:
    "https://andmed.stat.ee/api/v1/en/stat/majandus/rahandus/valitsemissektori-rahandus/valitsemissektori-tulud-kulud/RR056.PX",
  compiler: "GovEesti — derived: total health expenditure (RR056, function 07) ÷ mid-year population. Statistikaamet does not publish a ready per-capita series.",
  cadence: "annual",
...
const eduPupilTeacherRatio: TrendSeries = {
  ...
  goodDirection: "down",
  producer: "Statistikaamet (HT121 and HT235 tables)",
  sourceUrl: "https://andmed.stat.ee/api/v1/en/stat/sotsiaalelu/haridus/uldharidus/HT121.px",
  compiler: "GovEesti — derived ratio: enrolments (HT121) ÷ teachers (HT235). Statistikaamet does not publish this ratio directly.",
  cadence: "annual",
...
const intRecordedCrimes: TrendSeries = {
  ...
  goodDirection: "down",
  producer: "Ministry of Justice and Digital Affairs (statistics portal)",
  sourceUrl: "https://statistika.justdigi.ee/en/crime-statistics",
  compiler: "GovEesti — direct pass-through; parses the \"Total\" row per year out of the source CSV.",
  cadence: "annual",
...
const defPersonnelPer1000: TrendSeries = {
  ...
  compiler: "GovEesti — derived per-1,000 ratio: MS.MIL.TOTL.P1 is an absolute headcount, not a per-capita rate, so this cannot be a direct pass-through; divided by SP.POP.TOTL population and scaled per 1,000.",
  cadence: "annual",
...
const finGdpPerCapita: TrendSeries = {
  ...
  shortFormat: fmtEur,
  goodDirection: "up",
  producer: "Statistikaamet (RAA0013)",
  sourceUrl:
...
const econUnemploymentRate: TrendSeries = {
  ...
  shortFormat: fmtPct,
  goodDirection: "down",
  producer: "Statistikaamet (TT3300, Estonian Labour Force Survey)",
  sourceUrl:
