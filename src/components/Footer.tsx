  ...
  return (
    <footer className="mt-16 flex flex-col items-start justify-between gap-3 border-t border-border pt-6 text-xs text-muted-foreground sm:flex-row sm:items-center">
      <div className="max-w-2xl">
        ...
        build time from Statistikaamet, Eurostat, World Bank and other
        official sources. Indicators with no source wired yet are left blank
        rather than shown as fabricated trends.
      </div>
      <a
